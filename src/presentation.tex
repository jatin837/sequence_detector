...
\begin{document}
  ...
  \frame{
      ...
      \begin{table}[]
        ...
        \hline
        Present State & \multicolumn{4}{l|}{Next State / Output}                \\ \hline
                      & \multicolumn{2}{l|}{X = 0} & \multicolumn{2}{l|}{X = 1} \\ \hline
        A             & \multicolumn{2}{l|}{A/0}   & \multicolumn{2}{l|}{B/0}   \\ \hline
        B             & \multicolumn{2}{l|}{A/0}   & \multicolumn{2}{l|}{C/0}   \\ \hline
        C             & \multicolumn{2}{l|}{D/0}   & \multicolumn{2}{l|}{C/0}   \\ \hline
        D             & \multicolumn{2}{l|}{A/0}   & \multicolumn{2}{l|}{E/0}   \\ \hline
        E             & \multicolumn{2}{l|}{A/0}   & \multicolumn{2}{l|}{C/1}   \\ \hline
        \end{tabular}
        \end{table}
    }
\end{document}
